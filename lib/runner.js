...
Runner.prototype.createBrowser = function(plugins) {
  ...
  browser_.ready = function() {
      driver.manage().timeouts().setScriptTimeout(config.allScriptsTimeout);
      var promise = driver.manage().timeouts().setScriptTimeout(config.allScriptsTimeout);
      return promise;
  }
...
Runner.prototype.run = function() {
  ...
  // 2) Create a browser and setup globals
    ...
    return browser_.ready().then(function() {
      return browser_.getSession();
